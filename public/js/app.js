...
var render = function() {
  ...
  return _c("div", {}, [
    ...
    _c(
      "div",
      { staticClass: "w-full min-h-full h-auto" },
      [_c("router-view")],
      1
    )
  ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "w-full bg-white" }, [
      _c("div", { staticClass: "flex TopBar flex-row mx-auto pl-4 pr-4" }, [
        _c("img", {
          staticClass: "mx-auto logo",
          attrs: { src: "/img/Logo_XFG_FRANCHISE.png", alt: "" }
        })
      ])
    ])
  }
...
var routes = [{
  ...
  beforeEnter: auth,
  component: function component() {
    return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ../views/main.vue */ "./resources/js/views/main.vue"));
  }
}];
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    sendLoginRequest: function sendLoginRequest(_ref2, data) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/" + "login", data).then(function (response) {
    ...
    sendRegisterRequest: function sendRegisterRequest(_ref3, data) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/" + "register", data).then(function (response) {
        commit("setUserData", response.data.user);
        localStorage.setItem("authToken", response.data.token);
      });
    },
    ...
    sendVerifyResendRequest: function sendVerifyResendRequest() {
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/" + "email/resend");
    },
    sendVerifyRequest: function sendVerifyRequest(_ref5, hash) {
      var dispatch = _ref5.dispatch;
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/" + "email/verify/" + hash).then(function () {
...
__webpack_require__(/*! C:\Users\PC\Desktop\Roboczy\franczyzaCMS\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\PC\Desktop\Roboczy\franczyzaCMS\resources\sass\app.scss */"./resources/sass/app.scss");
